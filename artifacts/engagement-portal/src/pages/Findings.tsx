    ...
    <div className="w-full px-6 md:px-10 py-8 md:py-10 fade-in">
      <header className="mb-10">
        ...
        <p className="text-base text-muted-foreground leading-relaxed max-w-3xl">
          ...
          planning, through the Jun 8 / 10 / 12 discovery sessions and the ASM SQL / Layout analysis, to the MAO-004 data
          gap analysis. A check means the finding (or the risk or scope theme it stems from) surfaced in that source.
          Each finding carries a stable ID, the sources it appeared in, and a traceability link to the Gap &amp; Risk
      ...
      <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
        ...
        <span>
          Sources: Pre Kickoff &amp; Kickoff planning, the Jun 8 / 10 / 12, 2026 discovery sessions, the ASM SQL /
          Layout analysis, and the MAO-004 data gap analysis. Column headers link to each source.
        </span>
      </div>
    </div>
  );
